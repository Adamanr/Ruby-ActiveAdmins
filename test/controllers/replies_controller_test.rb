...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { blog_id: @reply.blog_id, text: @reply.text, user_id: @reply.user_id } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { blog_id: @reply.blog_id, text: @reply.text, user_id: @reply.user_id } }
